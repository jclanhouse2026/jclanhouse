                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                        {filteredThemes.map(theme => (
                            <div key={theme.id} className="bg-slate-800 rounded-xl overflow-hidden shadow-lg border border-slate-700 group hover:border-cyan-500/50 transition-all">
                                <div className="relative aspect-square">
                                    ...
                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                                        ...
                                        <button onClick={() => handleDelete(theme.id)} className="bg-white text-slate-900 p-2.5 rounded-full hover:bg-red-500 hover:text-white transition-colors shadow-xl">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-6">
                                        ...
                                        <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                            ...
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button 
                                                    onClick={() => {
                                                        if (window.confirm('Excluir este pedido?')) deleteMugOrder(order.id);
                                                    }}
